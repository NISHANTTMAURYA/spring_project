...
SELECT 'Complete project', 'Finish the Spring Boot Todo project with Gemini Vision integration', DATE_ADD(CURRENT_DATE, INTERVAL 7 DAY), false, 'HIGH', id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
INSERT INTO todos (title, description, due_date, completed, priority, user_id, created_at, updated_at)
SELECT 'Learn more about AI', 'Study Gemini Vision API capabilities', DATE_ADD(CURRENT_DATE, INTERVAL 14 DAY), false, 'MEDIUM', id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM users WHERE username = 'admin'
